...
import numpy as np
from podm.evaluators.pascal_voc_evaluator import (
    calculate_ap_11_point_interp,
    calculate_ap_every_point,
)
from podm.tube import Tube
from podm.utils.enumerators import MethodAveragePrecision
from podm.utils.read_files import File
...
class TubeEvaluator:
    ...
    def __init__(
        ...
        Args:
            ...
            method (MethodAveragePrecision, optional): Recall interpolation method (see podm.utils.enumerators). Defaults to MethodAveragePrecision.EVERY_POINT_INTERPOLATION.
        """
